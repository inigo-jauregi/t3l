...
def main():
    ...
    raw_list = []
    with open('../../my_datasets/sequence_classification/MULTI_EURLEX/level_1/en/validation.en', 'r') as reader:
        for line in reader:
    ...
    with open('../../my_datasets/sequence_classification/MULTI_EURLEX/level_1/en/validation.pt', 'w') as writer:
