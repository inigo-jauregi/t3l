...
TRAIN=my_datasets/translation/IWSLT_2014_TEDtalks/es-en/train_pr
DEV=my_datasets/translation/IWSLT_2014_TEDtalks/es-en/dev2010
TEST=my_datasets/translation/IWSLT_2014_TEDtalks/es-en/test_joined

SRC=es
TGT=en

OUT=models/iwslt/pretrained_mts/es-en/es_en_mbart_pr_model_50_m2o_max_seq_len_85
