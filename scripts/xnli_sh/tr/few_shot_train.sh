...
for SAMPLE in 10; do
  ...
  TRAIN=my_datasets/sequence_classification/xnli/dev-tr-mini_dev-mini_dev_$SAMPLE.tsv
  ...
  for SEED in 1 2 3; do
    OUT=models/xnli/few_shot/tr/mBart_tr_en_50m2o_lr_3e-6_seed_$SEED.SAMPLES_$SAMPLE
