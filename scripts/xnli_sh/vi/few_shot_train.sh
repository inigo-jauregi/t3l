...
for SAMPLE in 10; do
  ...
  TRAIN=my_datasets/sequence_classification/xnli/dev-vi-mini_dev-mini_dev_$SAMPLE.tsv
  DEV=my_datasets/sequence_classification/xnli/dev-vi-mini_test.tsv
  TEST=my_datasets/sequence_classification/xnli/test-vi.tsv


  for SEED in 1 2 3; do

    OUT=models/xnli/few_shot/vi/mBart_en_vi_50m2o_lr_3e-6_seed_$SEED.SAMPLES_$SAMPLE
