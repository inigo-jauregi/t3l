...
for SAMPLE in 10; do
  ...
  TRAIN=my_datasets/sequence_classification/xnli/dev-ru-mini_dev-mini_dev_$SAMPLE.tsv
  DEV=my_datasets/sequence_classification/xnli/dev-ru-mini_test.tsv
  TEST=my_datasets/sequence_classification/xnli/test-ru.tsv

  for SEED in 1 2 3; do

    OUT=models/xnli/few_shot/ru/mBart_en_ru_50m2o_lr_3e-6_seed_$SEED.SAMPLES_$SAMPLE
