...
TRAIN=my_datasets/translation/IWSLT_2014_TEDtalks/hi-en/train
DEV=my_datasets/translation/IWSLT_2014_TEDtalks/hi-en/test
TEST=my_datasets/translation/IWSLT_2014_TEDtalks/hi-en/test

SRC=hi
TGT=en

OUT=models/iwslt/pretrained_mts/hi-en/hi_en_mbart_pr_model_50_m2o_max_seq_len_85
