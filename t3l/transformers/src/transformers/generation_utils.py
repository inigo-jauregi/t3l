...
from .generation_logits_process import (
    ...
    MyForcedEOSTokenLogitsProcessor,
...
class GenerationMixin:
    ...
    def _get_logits_processor(
        ...
        if forced_eos_token_id is not None:
            if jttl:
                processors.append(MyForcedEOSTokenLogitsProcessor(max_length, forced_eos_token_id))
            else:
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if return_dict_in_generate:
                if output_scores:
                    if scores == ():
                        ...
                        scores = torch.cat((scores, next_token_logits.unsqueeze(1)), dim=1)
            ...
            # print(torch.nonzero(torch.isnan(next_tokens_scores.view(-1))))

            # TODO: argmax -> Gumbel-Softmax ??
